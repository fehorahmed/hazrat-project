                ...
                <div class="col-xxl-4 col-lg-5">
                    <div class="card">
                        ...
                        <div class="card-header pt-3 pb-3 text-center bg-primary">
                            <h4 class="text-white">Trainee Login</h4>
                            {{--                        <a href="index.html"> --}}
                        ...
                        <div class="card-body p-4">
                            ...
                            <form method="POST" action="{{ route('trainee.login.post') }}">
                                @csrf
                                <div class="mb-3">
                                    <label for="emailaddress" class="form-label">Email Address / Mobile Number </label>
                                ...
                                <a class="underline text-sm text-gray-600 hover:text-gray-900"
                                    href="{{ route('trainee.password.request') }}">
                                    {{ __('Forgot your password?') }}
                                </a>
