...
@section('content')
    <section class="py-3">
        <div class="container">
            ...
            <form action="{{ route('trainee.application.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card border-secondary border">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div style="background: rgb(240, 240, 239);" class="card text-dark">
                                    <div class="card-header bg-info text-light font-18">
                                        <b>Personal Information</b>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="px-md-4 col-md-6 px-lg-4 col-lg-6">
                                                <div class="mb-3">
                                                    <label class="form-label font-16">নাম</label>
                                                    <input type="text" class="form-control" data-provide="typeahead"
                                                        id="name"
                                                        value="{{ auth()->guard('trainee')->user()->name ?? '' }}"
                                                        name="name" readonly placeholder="Name">
                                                    @error('name')
                                            ...
                                            <div class="px-md-4 col-md-6 px-lg-4 col-lg-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" data-provide="typeahead"
                                                        name="mobile"
                                                        value="{{ old('mobile',auth()->guard('trainee')->user()->phone) }}"
                                                        {{ auth()->guard('trainee')->user()->phone? 'readonly': '' }}
                                            ...
                                            <div class="px-md-4 col-md-6 px-lg-4 col-lg-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea data-toggle="maxlength" class="form-control" name="permanent_address" id="permanent_address"
                                                        maxlength="225" rows="6" placeholder="Permanent Address">{{ old('permanent_address') }}</textarea>
                                            ...
                                            <div class="px-md-4 col-md-6 px-lg-4 col-lg-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control select2" name="present_division"
                                                        ...
                                                        @foreach ($divisions as $division)
                                                            <option
                                                                {{ old('present_division') == $division->id ? 'selected' : '' }}
                                                                value="{{ $division->id }}">{{ $division->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea data-toggle="maxlength" class="form-control" name="present_address" id="present_address" maxlength="225"
                                                        rows="6" placeholder="Present Address">{{ old('present_address') }}</textarea>
                                            ...
                                            <div class="px-md-4 col-md-6 px-lg-4 col-lg-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" name="last_education"
                                                        ...
                                                        @foreach ($educations as $education)
                                                            <option
                                                                {{ old('last_education') == $education->id ? 'selected' : '' }}
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="file" id="example-fileinput"
                                                        name="educational_certificate" required class="form-control">
                                                    <p>Image must be less than 2MB. </p>
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label">বেসিত কোর্স সনদ প্রদানকারী প্রতিষ্ঠানের
                                                        ধরন</label>
                                                    <select class="form-select" name="basis_institute_type"
                                                        ...
                                                        @foreach ($institute_types as $institute_type)
                                                            <option
                                                                {{ old('basis_institute_type') == $institute_type->id ? 'selected' : '' }}
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="file" id="example-fileinput"
                                                        name="basis_institute_certificate" required class="form-control">
                                                    <p>Image must be less than 2MB. </p>
                                            ...
                                            <div class="px-md-4 col-md-6 px-lg-4 col-lg-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="radio" data-provide="typeahead" value="1"
                                                        ...
                                                        {{ old('current_education_status') == '1' ? 'checked' : '' }}>
                                                    Yes
                                                    <input type="radio" data-provide="typeahead" value="0"
                                                        name="current_education_status"
                                                        {{ old('current_education_status') == '0' ? 'checked' : '' }}>
                                                    No
                                            ...
                                            <div class="px-md-4 col-md-6 px-lg-4 col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="radio" data-provide="typeahead" value="1"
                                                        ...
                                                        {{ old('business_status') == '1' ? 'checked' : '' }}>
                                                    Yes
                                                    <input type="radio" data-provide="typeahead" value="0"
                                                        name="business_status"
                                                        {{ old('business_status') == '0' ? 'checked' : '' }}>
                                                    No
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" name="computer_course_duration"
                                                        ...
                                                        @foreach ($course_durations as $course_duration)
                                                            <option
                                                                {{ old('computer_course_duration') == $course_duration->id ? 'selected' : '' }}
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" name="quota" id="quota">
                                                        ...
                                                        @foreach ($quotas as $quota)
                                                            <option {{ old('quota') == $quota->id ? 'selected' : '' }}
                        ...
                        <div class="row">
                            <div class="col-12 text-center">
                                <input type="checkbox" name="" id="check_box" class="text-danger" required>
                                <label for="check_box" class="text-danger font-16">Please
...
@push('scripts')
    <script>
        $(function() {
            ...
            //Present /////////////
            var pre_districtSelected = '{{ old('present_district') }}'
            ...
            var pre_subDistrictSelected = '{{ old('present_upazila') }}';
