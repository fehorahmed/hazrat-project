...
{{--                    <li class="mt-2"><a href="javascript: void(0);" class="text-muted">Privacy</a></li>--}}
                    <li class="mt-2"><a href="{{route('login')}}" class="text-muted">Admin Login</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="mt-5">
                    <p class="text-muted mt-4 text-center mb-0">© 2023 Sheikh Hasina National Institute of Youth Development</p>
                </div>
            </div>
        </div>
    </div>
