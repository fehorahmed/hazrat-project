@extends('admin.app')
@section('title')
    {{ isset($pageTitle) ? $pageTitle : 'Course Duration' }}
@endsection
            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <div class="d-flex">
                            <a href="{{ route('admin.config.application.date.create') }}" class="btn btn-primary">Create
                                Apply Date</a>
                        </div>
                    </div>
                    <h4 class="page-title">Last Apply Date List</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                            ...
                            <tbody>
                                @foreach ($datas as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.config.application.date.edit', $data->id) }}"
...
@push('scripts')
    <script>
        ...
        $(function() {
            var districtSelected = '{{ request('district', \Illuminate\Support\Facades\Auth::user()->district_id) }}'
