            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <div class="d-flex">
                            <a href="{{ route('admin.config.course.duration.create') }}" class="btn btn-primary">Create
                                Course Duration</a>
                        </div>
                    </div>
                    <h4 class="page-title">Course Duration List</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                            ...
                            <tbody>
                                @foreach ($datas as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.config.course.duration.edit', $data->id) }}"
