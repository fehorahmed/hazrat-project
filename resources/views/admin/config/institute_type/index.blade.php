            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <div class="d-flex">
                            <a href="{{ route('admin.config.institute.type.create') }}" class="btn btn-primary">Create
                                Education</a>
                        </div>
                    </div>
                    <h4 class="page-title">Institute Type List</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                            ...
                            <tbody>
                                @foreach ($datas as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.config.institute.type.edit', $data->id) }}"
