@extends('admin.app')
@section('title')
    {{ isset($pageTitle) ? $pageTitle : 'Development Courses' }}
@endsection
            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <div class="d-flex">
                            <a href="{{ route('admin.config.development-course.create') }}" class="btn btn-primary">Create Course</a>
                        </div>
                    </div>
                    <h4 class="page-title">Development Courses List</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
