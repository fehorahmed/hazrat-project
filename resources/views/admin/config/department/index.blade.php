@extends('admin.app')
@section('title')
    {{ isset($pageTitle) ? $pageTitle : 'Departments' }}
@endsection
            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <div class="d-flex">
                            <a href="{{ route('admin.config.department.create') }}" class="btn btn-primary">Create
                                Department</a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @foreach ($datas as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.config.department.edit', $data->id) }}"
