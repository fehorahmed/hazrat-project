            ...
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="owl-carousel portfolio-slider">
                        <div class="single-pf">
                            <img src="{{ asset('front-assets') }}/img/pf1.jpg" alt="#">
                            <a href="portfolio-details.html" class="btn">View Details</a>
                        </div>
                        <div class="single-pf">
                            <img src="{{ asset('front-assets') }}/img/pf2.jpg" alt="#">
                            <a href="portfolio-details.html" class="btn">View Details</a>
                        </div>
                        <div class="single-pf">
                            <img src="{{ asset('front-assets') }}/img/pf3.jpg" alt="#">
                            <a href="portfolio-details.html" class="btn">View Details</a>
                        </div>
                        <div class="single-pf">
                            <img src="{{ asset('front-assets') }}/img/pf4.jpg" alt="#">
                            <a href="portfolio-details.html" class="btn">View Details</a>
                        </div>
                        <div class="single-pf">
                            <img src="{{ asset('front-assets') }}/img/pf1.jpg" alt="#">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-news">
                        <div class="news-head">
                            <img src="{{ asset('front-assets') }}/img/blog1.jpg" alt="#">
                        </div>
                        <div class="news-body">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-news">
                        <div class="news-head">
                            <img src="{{ asset('front-assets') }}/img/blog2.jpg" alt="#">
                        </div>
                        <div class="news-body">
                            <div class="news-content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-news">
                        <div class="news-head">
                            <img src="{{ asset('front-assets') }}/img/blog3.jpg" alt="#">
                        </div>
                        <div class="news-body">
                            <div class="news-content">
                ...
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="owl-carousel clients-slider">
                        <div class="single-clients">
                            <img src="{{ asset('front-assets') }}/img/client1.png" alt="#">
                        </div>
                        <div class="single-clients">
                            <img src="{{ asset('front-assets') }}/img/client2.png" alt="#">
                        </div>
                        <div class="single-clients">
                            <img src="{{ asset('front-assets') }}/img/client3.png" alt="#">
                        </div>
                        <div class="single-clients">
                            <img src="{{ asset('front-assets') }}/img/client4.png" alt="#">
                        </div>
                        <div class="single-clients">
                            <img src="{{ asset('front-assets') }}/img/client5.png" alt="#">
                        </div>
                        <div class="single-clients">
                            <img src="{{ asset('front-assets') }}/img/client1.png" alt="#">
                        </div>
