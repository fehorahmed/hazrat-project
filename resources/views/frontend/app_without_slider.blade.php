...
<body>
    ...
    <!-- jquery Migrate JS -->
    <script src="{{ asset('front-assets') }}/js/jquery-migrate-3.0.0.js"></script>
    <!-- jquery Ui JS -->
    <script src="{{ asset('front-assets') }}/js/jquery-ui.min.js"></script>
    <!-- Easing JS -->
    <script src="{{ asset('front-assets') }}/js/easing.js"></script>
    <!-- Color JS -->
    <script src="{{ asset('front-assets') }}/js/colors.js"></script>
    <!-- Popper JS -->
    ...
    <!-- Slicknav JS -->
    <script src="{{ asset('front-assets') }}/js/slicknav.min.js"></script>
    <!-- ScrollUp JS -->
    ...
    <!-- Steller JS -->
    <script src="{{ asset('front-assets') }}/js/steller.js"></script>
    <!-- Wow JS -->
